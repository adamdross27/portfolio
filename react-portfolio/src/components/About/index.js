        ...
        <>
            <div className='container about-page'>
                <div className='text-zone'>
                    ...
                    <p>
                        In 2024, I led a team of five students from AUT on a Research & Development project for <b>CAITO AI</b>, a company 
                        specializing in transforming unstructured data into actionable insights for clients. <b>As the project leader, I was 
                        responsible</b> for outlining the project <b>management methodology</b>, and we decided to implement the Agile Scrum methodology, 
                        ...
                        <br /><br />
                        We created the <b>CAITO Workforce Intelligence System</b> (CAITO WIS), a platform that allows users to web scrape or insert 
                        ...
                        <br /><br />
                        The CAITO WIS was developed using the <b>FERN stack</b> (Firebase, Express.js, React.js, Node.js), providing a full-stack 
                    ...
                    <p>
                        I have graduated from Auckland University of Technology with a <b>Bachelor of Computer and Information Sciences</b>,
                        <i> majoring in Software Development, and minoring in Networks & Cybersecurity.</i> <b>Graduating with an A- overall (7.16/9)
